...
>(({ className, children, description, ...props }, ref) => (
  ...
  >
    ...
    <View>
      <SelectPrimitive.ItemText className="native:text-lg native:text-base font-main text-sm text-popover-foreground web:group-focus:text-accent-foreground" />
      {description && (
        <SelectPrimitive.ItemText className="font-main text-xs/relaxed text-muted-foreground">
          {description}
